    ...
    public void drawString(final String str, final int x, final int y, final int anchor) {
        queue(new Renderable() {
            public void render() {
                ...
                //string.release();
                context.showTextAtPoint(newy, newy, str);
            }
        });
    }
    ...
    public void setClip(final int x, final int y, final int width, final int height) {
        ...
        queue(new Renderable() {
            public void render() {
                ...
                context.restoreState();
                context.storeState();
                context.translate(currentTranslateX, currentTranslateY);
    ...
    public void setColor(final int RGB) {
        ...
        queue(new Renderable() {
            public void render() {
                ...
                int g = (RGB >> 8) & 0xFF;
                int b = (RGB >> 0) & 0xFF;
                currentColor = new float[]{((float) r) / 255f, ((float) g) / 255f, ((float) b) / 255f, 1f};
                context.setFillColor(currentColor);
                context.setStrokeColor(currentColor);
            }
        });
