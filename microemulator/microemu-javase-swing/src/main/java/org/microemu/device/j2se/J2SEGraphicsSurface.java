...
public class J2SEGraphicsSurface {
    ...
    private static final DirectColorModel COLOR_MODEL = 
	...
	public J2SEGraphicsSurface(int width, int height) {
        ...
        this.image = new BufferedImage(COLOR_MODEL, raster, true, new Hashtable());
