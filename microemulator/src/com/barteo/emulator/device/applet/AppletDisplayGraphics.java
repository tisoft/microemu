...
public class AppletDisplayGraphics extends javax.microedition.lcdui.Graphics implements DisplayGraphics 
{
	...
	public AppletDisplayGraphics(java.awt.Graphics a_g, MutableImage a_image) 
	{
		g = a_g;
		image = a_image;
		g.setFont(((AppletFontManager) DeviceFactory.getDevice().getFontManager()).getFontMetrics(currentFont).getFont());
	}
