...
public final class BWImageFilter extends RGBImageFilter
{
  ...
  public int filterRGB (int x, int y, int rgb)
    ...
    if (Y > 127) {
	    return a | 
          ((AppletDeviceDisplay) DeviceFactory.getDevice().getDeviceDisplay()).getBackgroundColor().getRGB();
		} else {
	    return a | 
          ((AppletDeviceDisplay) DeviceFactory.getDevice().getDeviceDisplay()).getForegroundColor().getRGB();
		}
  }
