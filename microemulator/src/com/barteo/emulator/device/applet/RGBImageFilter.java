...
public final class RGBImageFilter extends java.awt.image.RGBImageFilter
{
  ...
  public RGBImageFilter()
    ...
    backgroundColor = 
        ((AppletDeviceDisplay) DeviceFactory.getDevice().getDeviceDisplay()).getBackgroundColor();    
    foregroundColor = 
        ((AppletDeviceDisplay) DeviceFactory.getDevice().getDeviceDisplay()).getForegroundColor();    
