...
public class AppletDeviceDisplay implements DeviceDisplayImpl 
{
	...
	public void paint(Graphics g) 
	{
		...
		if (ma != null) {
			...
			ma.getDisplayAccess().paint(new AppletDisplayGraphics(g, getDisplayImage()));
		...
		if (scrollUp) {
			g.drawImage(((AppletImmutableImage) upImage.getImage()).getImage(), 
			        upImage.getRectangle().x, upImage.getRectangle().y, null);
		}
		if (scrollDown) {
			g.drawImage(((AppletImmutableImage) downImage.getImage()).getImage(), 
    		...
    		throws IOException 
	{
		...
		is = context.getClass().getResourceAsStream(str);
		if (is == null) {
	...
	private Image getImage(String str) 
			throws IOException 
	{
		InputStream is = context.getClass().getResourceAsStream(str);
