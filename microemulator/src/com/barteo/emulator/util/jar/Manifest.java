...
Modification:
  Bartek Teodorczyk (12-12-2001)
    moved to another package
*/
package com.barteo.emulator.util.jar;

import java.io.BufferedReader; // not in J2ME
import java.io.BufferedWriter; // not in J2ME
import java.io.IOException;
import java.io.InputStream;
import java.io.InputStreamReader;
import java.io.OutputStream;
import java.io.OutputStreamWriter;
import java.io.PrintWriter; // not in J2ME
import java.io.Reader;
import java.io.Writer;
import java.util.Hashtable;
import java.util.Iterator; // not in J2ME, JDK1.1
import java.util.Map; // not in J2ME, JDK1.1
import java.util.Set; // not in J2ME, JDK1.1
